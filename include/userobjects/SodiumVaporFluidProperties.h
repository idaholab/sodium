 ...
 */
class SodiumVaporFluidProperties : public SinglePhaseFluidProperties, public NaNInterface
{
public:
  SodiumVaporFluidProperties(const InputParameters & parameters);
  ...
  virtual Real T_from_h_p(Real h, Real p) const override;
  virtual void T_from_h_p(Real h, Real p, Real & T, Real & dT_dh, Real & dT_dp) const override;
