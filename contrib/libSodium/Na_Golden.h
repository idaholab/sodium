#pragma once
//
int DIFF_ps_t_Na(double t, double & ps, double & dpsdt, double & d2psdt2);
int DIFF_ts_p_Na(double p, double & ts, double & dtsdp, double & d2tsdp2);
int DIFF_d1_t_Na(double t, double & d1, double & dd1dt, double & d2d1dt2);
int DIFF_d_tp_L_Na(double t,
                   double p,
                   double & dl,
                   double & ddldt,
                   double & d2dldt2,
...
int DIFF_d_tp_L_Na(double t,
                   ...
                   double & d3dldt2dp,
                   double & d3dldtdp2);
int DIFF_v1_t_Na(double t, double & v1, double & dv1dt, double & d2v1dt2);
int DIFF_v_tp_L_Na(double t,
                   double p,
                   double & vl,
                   double & dvldt,
                   double & d2vldt2,
                   ...
                   double & d2vldp2,
                   double & d2vldtdp);
int DIFF_h1_t_Na(double t, double & h1, double & dh1dt, double & d2h1dt2);
int DIFF_vu_tp_L_Na(double t,
                    double p,
                    double & vl,
                    double & dvldt,
                    double & d2vldt2,
...
int DIFF_h_tp_L_Na(double t,
                   ...
                   double & d2hldp2,
                   double & d2hldtdp);
int DIFF_s1_t_Na(double t, double & s1, double & ds1dt, double & d2s1dt2);
int DIFF_s_tp_L_Na(double t,
                   double p,
                   double & sl,
                   double & dsldt,
                   double & d2sldt2,
...
int DIFF_qc_tp_Na(double t,
                  ...
                  double & d2b4dp2,
                  double & d2b4dtdp);
int DIFF_v2_t_Na(double t, double & v2, double & dv2dt, double & d2v2dt2);
int DIFF_v_tp_G_Na(double t,
                   double p,
                   double & vv,
                   double & dvvdt,
                   double & d2vvdt2,
                   ...
                   double & d2vvdp2,
                   double & d2vvdtdp);
int DIFF_dhv_t_Na(double t, double & dhv, double & ddhvdt, double & d2dhvdt2);
int DIFF_h2_t_Na(double t, double & h2, double & dh2dt, double & d2h2dt2);
int DIFF_vu_tp_G_Na(double t,
                    double p,
                    double & vv,
                    double & dvvdt,
                    double & d2vvdt2,
...
int DIFF_h_tp_G_Na(double t,
                   ...
                   double & d2hvdp2,
                   double & d2hvdtdp);
int DIFF_s2_t_Na(double t, double & s2, double & ds2dt, double & d2s2dt2);
int DIFF_s_tp_G_Na(double t,
                   double p,
                   double & sv,
                   double & dsvdt,
                   double & d2svdt2,
